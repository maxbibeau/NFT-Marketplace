      ...
      <div className="header-slider">
       ...
       <Slider {...settings} className='slider'>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>James Pepe</p>
              </Link>
              <p className='slider-card-price'>14.250 <span>QUAI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>Pepe Gaga</p>
              </Link>
              <p className='slider-card-price'>12.92 <span>QUAI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>Lady Pepe</p>
              </Link>
              <p className='slider-card-price'>7.60 <span>QUAI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>Pepe Jr.</p>
              </Link>
              <p className='slider-card-price'>4.15 <span>QUAI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>Pepe Badman</p>
              </Link>
              <p className='slider-card-price'>3.91 <span>QUAI</span></p>
            </div>
            <div className='slider-card'>
              ...
              <Link>
              <p className='slider-card-name'>Pepe Chad</p>
              </Link>
